      ...
      <div style={{
        ...
        <div style={{ padding: '24px 36px', display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ background: '#f8f7ff', borderRadius: 14, padding: '16px 20px' }}>
            <div style={{ fontWeight: 700, fontSize: 14, color: '#4b36cc', marginBottom: 10 }}>Adjustments Pathfinder made to your plan</div>
        ...
        <div style={{ padding: '0 36px 32px', display: 'flex', gap: 12 }}>
          ...
          <button onClick={onAccept} style={{ flex: 2, padding: '14px', borderRadius: 12, border: 'none', background: 'linear-gradient(135deg, #4b36cc, #7c3aed)', color: '#fff', fontWeight: 700, fontSize: 15, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
