...
export const dummyEvents = [
  {
    ...
    tags: ['AI', 'Hackathon', 'Beginners OK'], color: '#4b36cc', seats: '89 spots left', featured: true
  },
  {
...
export const roadmapData = {
  'Machine Learning': {
    ...
    phases: [
      {
        name: 'Foundation', duration: '6 weeks', status: 'active', color: '#4b36cc',
        modules: [
...
export const onboardingQuestions = [
  ...
  },
  {
    ...
    options: [
      { value: 'teen', label: 'Under 18', icon: '🎓', desc: 'Student / Explorer' },
      { value: 'young', label: '18–24', icon: '⚡', desc: 'College / Early career' },
      { value: 'mid', label: '25–35', icon: '💼', desc: 'Professional / Builder' },
      { value: 'senior', label: '35+', icon: '🏆', desc: 'Experienced / Pivot' },
    ]
  },
  {
    ...
    options: [
      { value: 'student', label: 'Full-time student', icon: '📚', desc: 'College or school' },
      { value: 'working', label: 'Working professional', icon: '💼', desc: 'Job alongside goals' },
      { value: 'freelancer', label: 'Freelancer', icon: '🖥️', desc: 'Flexible schedule' },
      { value: 'unemployed', label: 'Between jobs', icon: '🔍', desc: 'Open schedule' },
    ]
  },
  {
    ...
    options: [
      { value: 'tight', label: 'Budget is tight', icon: '🔒', desc: 'Free resources only' },
      { value: 'moderate', label: 'Some flexibility', icon: '💡', desc: 'Occasional paid tools ok' },
      { value: 'comfortable', label: 'Comfortable', icon: '✅', desc: 'Open to paid courses' },
      { value: 'flexible', label: 'No constraints', icon: '🚀', desc: 'Best resources, cost no issue' },
    ]
  },
  {
    ...
    options: [
      { value: '1-3', label: '1–3 hours', icon: '🌙', desc: 'Evenings only, tight schedule' },
      { value: '4-8', label: '4–8 hours', icon: '⏱️', desc: 'A few hours most days' },
      { value: '10-20', label: '10–20 hours', icon: '🔥', desc: 'Significant part-time effort' },
      { value: '20+', label: '20+ hours', icon: '💪', desc: 'Near full-time focus' },
    ]
  },
  {
    ...
    options: [
      { value: 'visual', label: 'Watching videos', icon: '🎬', desc: 'YouTube, lectures, demos' },
      { value: 'reading', label: 'Reading articles/docs', icon: '📖', desc: 'Blogs, documentation' },
      { value: 'handson', label: 'Building things', icon: '🛠️', desc: 'Projects, tutorials, labs' },
      { value: 'social', label: 'With others', icon: '👥', desc: 'Groups, cohorts, mentors' },
    ]
  },
  {
    ...
    options: [
      { value: 'novice', label: 'Complete beginner', icon: '🌱', desc: 'Just starting out' },
      { value: 'basic', label: 'Basic user', icon: '💻', desc: 'Can use apps and browse' },
      { value: 'intermediate', label: 'Tech-savvy', icon: '⚙️', desc: 'Comfortable with tools' },
      { value: 'advanced', label: 'Technical background', icon: '🔧', desc: 'Code/engineering exposure' },
    ]
  },
  {
    ...
    options: [
      { value: 'career', label: 'Get a better job', icon: '📈', desc: 'Career switch or promotion' },
      { value: 'income', label: 'Earn extra income', icon: '💰', desc: 'Freelance or side project' },
      { value: 'passion', label: 'Pure curiosity', icon: '🧠', desc: 'Learning for its own sake' },
      { value: 'build', label: 'Build something real', icon: '🏗️', desc: 'Product, app, startup' },
    ]
  },
];
...
export const thoughtQuestions = [
  ...
  },
  {
    ...
    allowMultiple: true,
    options: [
      { value: 'job', label: 'Land a job / internship', icon: '🎯' },
      { value: 'freelance', label: 'Get freelance clients', icon: '💼' },
      { value: 'startup', label: 'Build a startup', icon: '🚀' },
      { value: 'curiosity', label: 'Personal interest', icon: '🧠' },
      { value: 'academic', label: 'Academic requirement', icon: '📚' },
      { value: 'status', label: 'Skill upgrade / resume', icon: '⬆️' },
    ]
  },
  {
    ...
    options: [
      { value: '1month', label: '1 month', icon: '⚡', desc: 'Urgent / aggressive' },
      { value: '3months', label: '3 months', icon: '🔥', desc: 'Motivated, focused' },
      { value: '6months', label: '6 months', icon: '⏳', desc: 'Steady progress' },
      { value: '1year', label: '1 year+', icon: '🌱', desc: 'Long-term commitment' },
    ]
  },
  {
    ...
    options: [
      ...
      { value: 'money', label: "Can't afford courses", icon: '💸' },
      { value: 'start', label: "Don't know where to start", icon: '❓' },
      { value: 'motivation', label: "Lose motivation midway", icon: '😔' },
      { value: 'complexity', label: "It feels too complex", icon: '🤯' },
      { value: 'community', label: "No one to learn with", icon: '🏝️' },
    ]
  },
  {
    ...
    options: [
      { value: 'exploring', label: "Just exploring for now", icon: '🌊', desc: 'Casual interest' },
      { value: 'serious', label: "Serious about it", icon: '💡', desc: 'Regular effort' },
      { value: 'committed', label: "Fully committed", icon: '🔒', desc: 'Priority in my life' },
      { value: 'urgent', label: "Critical — I need this", icon: '🚨', desc: 'High urgency' },
    ]
  },
];
